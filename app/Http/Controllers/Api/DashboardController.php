...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $finalTotalPrevYear = (float)($user->prev_yr_gift_aid > 0 ? $user->prev_yr_gift_aid : $lastTaxYearAmountExpGiftAid);
        $finalTotalCurrYear = (float)($user->current_yr_gift_aid > 0 ? $user->current_yr_gift_aid : $currentyramountExpGiftAid);
