                    ...
                    <div class="form-container">
                        <div class="overflow mx-auto">
                            <table class="table shadow-sm">
                                ...
                                <tbody id="inner">
                                    @forelse ($batches->provoucher as $index => $voucher)
                                    ...
                                    <tr class="item-row">
                                        ...
                                        <td width="100px">
                                            <input style="min-width: 100px;" name="check[]" type="text" class="form-control check" value="{{ $voucher->cheque_no }}">
                                        </td>
                                        <td width="40px">
