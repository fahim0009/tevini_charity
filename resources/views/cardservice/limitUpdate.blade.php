    ...
    <div class="dashboard-content">
        ...
        <section class="profile purchase-status">
            <div class="title-section">
                ...
                <div class="mx-2">Balance Limit Update</div>
            </div>
        </section>
        ...
        <section class="px-4"  id="addThisFormContainer">
            <div class="row my-3">
                    ...
                    <div class="col-md-6  my-4 bg-white">
                        <form action="{{ route('cardprofile.limiteupdate') }}" method="POST" enctype="multipart/form-data" id="createThisForm">
                            @csrf
                         ...
                         <div class="col my-3">
                           ...
                           <input type="number" name="CreditLimit" id="CreditLimit" placeholder="Credit Limit" class="form-control @error('CreditLimit') is-invalid @enderror">
                        </div>
                    </div>
                    <div class="col-md-6  my-4  bg-white">
                    </div>
