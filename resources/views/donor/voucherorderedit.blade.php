            ...
            <div class="col-8">
                <div class="orderVoucher">
                    ...
                    @php
                        ...
                        $match = $orderhistories->firstWhere('voucher_id', $voucher->id);
                        ...
                        <div class="voucher">
                            ...
                            <div class="items">
                                <div class="cart mx-auto">
                                    ...
                                    <input type="hidden" class="total" id="vamnt{{$voucher->id}}" value="{{$amount}}">
                                    <input type="text" name="qty[]" id="cartValue{{$voucher->id}}" class="qty" value="{{$oldvqty}}" v_amount="{{ $voucher->amount }}" v_type="{{ $voucher->type }}" v_id="{{$voucher->id}}">
                            ...
                            <div class="items">
                                @if($voucher->type == "Prepaid")
                                    <div id="amt{{$voucher->id}}"><div class="items">£{{$amount}}</div></div>
                                @endif
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="row my-4">
                            <div class="col-lg-6">
                                <div class="inner">
                                    <div class="left text-center">
                                        <input type="checkbox" id="delivery" name="delivery" class="form-check largerCheckbox delivery_option" @if ($data->delivery_option == "Delivery") checked @endif>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="inner">
                                    <div class="left text-center">
                                        <input type="checkbox" id="collection"  name="collection"  class="form-check largerCheckbox delivery_option" @if ($data->delivery_option == "Collection") checked @endif>
                                    </div>
                                    <div class="right">
                                        <div class="title">
                                              Collection
                            ...
                            <div class="col-lg-6">
                                <div class="">
                                    <div class="">
                                        ...
                                        <input style="max-width:136px" type="text" id="d_charge" value="{{$data->delivery_charge}}" class="rounded text-center form-control fw-bold border-0" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="">
                                    <div class="">
                                        ...
                                        <input style="max-width:136px" type="number" id="net_total" class="rounded text-center form-control fw-bold border-0" value="{{$data->amount}}" readonly>
...
<script>
    ...
    $(document).ready(function () {
        ...
        //
        var url = "{{URL::to('/admin/voucher-update')}}";
        ...
        $("#addvoucher").click(function(){
            ...
            // console.log(delivery_charge);
                ...
                $.ajax({
                    url: url,
                    method: "POST",
                    data: {voucherIds:voucherIds,qtys:qtys,did:did,delivery_charge:delivery_charge,delivery:delivery,collection:collection,orderId:orderId,net_total:net_total},
