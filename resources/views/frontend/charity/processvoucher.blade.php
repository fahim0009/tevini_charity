                                ...
                                <td colspan="1">
                                    <div class="row">
                                        <div class="col-md-6 my-2">
                                            <button class="text-white btn-theme bg-primary d-block fs-14 fw-bold" id="addvoucher" type="button">Process Voucher</button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
