                ...
                <div class="charity-card">
                    ...
                    <div class="charity-card-body">
                        ...
                        <div class="charity-card-footer">
                            <p class="charity-card-desc" style="font-size:15px !Important;">For more details check our website.</p>
                            <a href="#" class="btn-theme bg-secondary">Website</a>
                            <a href="#" class="btn-theme bg-primary">Donate</a>
                        </div>
                    </div>
                </div>
            </div>
