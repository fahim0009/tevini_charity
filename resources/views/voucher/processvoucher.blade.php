        ...
        <div class="title-section d-flex justify-content-between align-items-center">
            ...
            <div class="ml-auto">
                <div class="d-flex align-items-center justify-content-end" style="height:100%;">
                    <button class="text-decoration-none bg-dark text-white py-1 px-3 rounded mb-1" data-inline="false" data-toggle="modal" data-target="#fullWidthModal" style="cursor: pointer;">OCR</button>
                </div>
