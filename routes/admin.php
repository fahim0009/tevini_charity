...
| ADMIN ROUTES
|--------------------------------------------------------------------------
| All admin routes are protected by 'auth' and 'is_admin' middleware.
|--------------------------------------------------------------------------
*/
Route::group(['prefix' => 'admin/', 'middleware' => ['auth', 'is_admin']], function () {
    ...
    */
    ...
    Route::get('/user-delete-request', [AdminController::class, 'getUserDeleteRequest'])
        ->name('allUserDeleteReq');
    ...
    */
    ...
    |----------------------------------------------------------------------
    */
    Route::post('/new-information', [CredentialController::class, 'newUserCredentialStore'])
        ->name('newUserCredentialStore');
    Route::put('/user-email/update/{id}', [CredentialController::class, 'update'])
        ->name('useremail.update');
    Route::delete('/user-email/delete/{id}', [CredentialController::class, 'destroy'])
        ->name('useremail.destroy');
    Route::post('/useremail-store', [CredentialController::class, 'charityEmailStore'])
        ->name('useremail.store');
    Route::post('/useremail-update', [CredentialController::class, 'charityEmailupdate'])
        ->name('charityemail.update');
    ...
    */
    ...
    Route::get('/transaction/details', [TransactionController::class, 'getDayDetails'])
        ->name('dailytransaction.details');
    Route::post('/transaction/toggle-payment', [TransactionController::class, 'toggleCharityPayment'])
    ...
    // Charity Transaction
    Route::get('/charity-transaction/{id}', [TransactionController::class, 'charityTransaction'])
        ->name('charity.tranview');
    Route::post('/charity-transaction/{id}', [TransactionController::class, 'charityTransaction'])
        ->name('charity.tranview_search');
    Route::post('/charity-transaction-update-date', [TransactionController::class, 'updateDate'])
    ...
    */
    ...
    Route::put('/donor/update-gift-aid/{id}', [DonorController::class, 'updateGiftAid'])
        ->name('donor.update_gift_aid');

    /*
    |----------------------------------------------------------------------
    | DONORS - PROFILE & RELATED DATA
    |----------------------------------------------------------------------
    */
    Route::get('/donor-profile/{id}', [UserController::class, 'profileinAdmin'])
        ->name('donor.profile');
    Route::get('/donor-transaction/{id}', [TransactionController::class, 'donorTransaction'])
        ->name('donor.tranview');
    Route::post('/donor-transaction/{id}', [TransactionController::class, 'donorTransaction'])
        ->name('search.donortran');
    Route::get('/donation-record/{id}', [DonorController::class, 'userDonationrecodinAdmin'])
        ->name('donor.donationrecord');
    Route::get('/standing-order/{id}', [DonorController::class, 'userStandingOrderinAdmin'])
        ->name('donor.standingorder');
    Route::get('/donor-order-history/{id}', [OrderController::class, 'userOrderinAdmin'])
        ->name('donor.orderhistory');
    Route::get('/donor-giving', [DonorController::class, 'adminDonorGiving'])
        ->name('donorgiving');
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/donor-report/{id}', [DonorController::class, 'userReportinAdmin'])
        ->name('donor.report');
    Route::get('/donor-topup-report/{id}', [DonorController::class, 'userTopReportinAdmin'])
        ->name('donor.topupreport');
    Route::get('/donor-topup-report-show/{id}', [DonorController::class, 'userTopReportShowinAdmin'])
        ->name('topup.reportShow');
    Route::post('/donor-report/{id}', [DonorController::class, 'userReportinAdmin'])
        ->name('donor.reportsearch');
    Route::post('/donor-report-mail', [DonorController::class, 'userReportMailinAdmin'])
        ->name('donor.reportmail');
    Route::post('/donor-topup-report-mail', [DonorController::class, 'userTopupReportMailinAdmin'])
        ->name('donor.topupreportmail');
    Route::post('/reportall', [DonorController::class, 'multiUserreport'])
        ->name('muliti.report');

    /*
    |----------------------------------------------------------------------
    | DONORS - ACTIONS (Donation, TDF Transfer, Topup)
    |----------------------------------------------------------------------
    */
    Route::get('/make-donation/{id}', [DonorController::class, 'userDonationAdmin'])
        ->name('donor.donation');
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/donor-custom-mail', [DonorController::class, 'addDonorMail'])
        ->name('admin.donor.email');
    Route::post('/donor-custom-mail', [DonorController::class, 'donorMailSend'])
        ->name('allDonorMailSend');
    ...
    Route::post('/text-message/{id}', [OTPController::class, 'sendText'])
        ->name('admin.donor.sendtext');
    ...
    */
    ...
    Route::get('/add-charity/delete/{id}', [CharityController::class, 'deleteCharity'])
        ->name('deletecharity');

    // Charity Status Toggles
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/charity-topup/{id}/{amount?}', [CharityController::class, 'topup'])
        ->name('charity.topup');
    Route::get('/charity-pay/{id}/{amount?}', [CharityController::class, 'pay'])
        ->name('charity.pay');
    Route::post('/charity-topupstore', [CharityController::class, 'topupStore'])
        ->name('charity.topup.store');
    Route::post('/charity-paystore', [CharityController::class, 'payStore'])
        ->name('charity.pay.store');
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/charity-email/{id}', [CharityController::class, 'charityemail'])
        ->name('charityemail');
    Route::post('/charity-email', [CharityController::class, 'charitymailsend'])
        ->name('charitymailsend');

    /*
    |----------------------------------------------------------------------
    | DONATIONS - LIST & STATUS
    |----------------------------------------------------------------------
    */
    Route::get('/donation/list', [DonorController::class, 'donationlist'])->name('donationlist');
    Route::get('/donation/pending-list', [DonorController::class, 'pendingdonationlist'])
        ->name('pendingdonationlist');
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/donation/standing', [DonationController::class, 'donationStanding'])
        ->name('donationstanding');
    Route::get('/donation/standing/{id}', [DonationController::class, 'singledonationStanding'])
        ->name('singlestanding');
    ...
    */
    ...
    Route::get('/admin/campaign/data', [CampaignController::class, 'campaignData'])
        ->name('campaign.data');
    ...
    // Campaign Reports
    Route::post('/campaign-report', [CampaignController::class, 'campaignReport'])
        ->name('campaignReport');
    Route::get('/cmpgn/donor-list/{id?}', [CampaignController::class, 'getAllCampaignDonor'])
        ->name('campaign.donor_list');
    ...
    */
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/process-voucher', [OrderController::class, 'processVoucher'])
        ->name('processvoucher');
    ...
    Route::post('/pvoucher-store', [OrderController::class, 'pvoucherStore'])
        ->name('pvoucher.store');
    ...
    Route::post('/pdf-to-text', [ProcessVoucherController::class, 'uploadAndExtractMultiplepdf'])
        ->name('pdfToText');
    Route::post('/add-to-process', [ProcessVoucherController::class, 'addToProcessBarcode'])
        ->name('addToProcessBarcode');
    Route::post('/delete-process-voucher-list', [ProcessVoucherController::class, 'deleteProcessBarcode'])
        ->name('delete-process-voucher-list');
    Route::post('/delete-process-voucher-image-list', [ProcessVoucherController::class, 'deleteProcessBarcodeImage'])
    ...
    */
    ...
    Route::get('/donor-voucher-order/{id}', [OrderController::class, 'voucherinAdmin'])
        ->name('donor.vorder');
    Route::get('/donor-voucher-order-edit/{id}', [OrderController::class, 'voucherEditinAdmin'])
        ->name('donor.vorderEdit');
    Route::get('/donor-voucher-report/{id}', [OrderController::class, 'voucherReportinAdmin'])
        ->name('donor.vorderReport');
    ...
    // Expired Vouchers
    Route::get('/expired-voucher', [ExpiredVoucherController::class, 'getExpiredVoucher'])
        ->name('expiredVoucher');
    ...
    */
    ...
    Route::get('/download-postage/{id}', [OrderController::class, 'downloadpostage'])
        ->name('downloadpostage');
    ...
    Route::post('/barcode-delete', [VouchersController::class, 'getBarcode'])
        ->name('admin.getBarcodeSearch');
    Route::post('/all-barcode-delete', [VouchersController::class, 'deleteBarcode'])
        ->name('admin.deleteBarcode');

    // Order History Check (for 360 amount order)
    Route::get('/check-some-order', [VouchersController::class, 'checkOrder'])
        ->name('checkOrder');
    ...
    */
    ...
    Route::post('/clear-barcode', [OrderController::class, 'clearBarcode'])
        ->name('admin.clearBarcode');
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | PAYMENTS - TDF TRANSACTIONS
    |----------------------------------------------------------------------
    */
    Route::get('/tdf-transaction', [TDFTransactionController::class, 'getTDFTransaction'])
        ->name('tdfTransaction');
    Route::get('/tdf-transaction-complete', [TDFTransactionController::class, 'getTDFTransactionComplete'])
        ->name('tdfTransactionComplete');
    Route::get('/tdf-transaction-cancel', [TDFTransactionController::class, 'getTDFTransactionCancel'])
        ->name('tdfTransactionCancel');
    Route::post('/tdf-transaction', [TDFTransactionController::class, 'tdfBlanceStore'])
        ->name('tdfTransaction.update');
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/balance-transfer', [BalanceTransferController::class, 'getBalanceTransferByAdmin'])
        ->name('admin.balanceTransfer');
    Route::get('/donor-balance-transfer/{id}', [BalanceTransferController::class, 'getDonorBalanceTransferByAdmin'])
        ->name('donor.balanceTransfer');
    Route::post('/balance-transfer-status', [BalanceTransferController::class, 'changeStatus']);

    // Donor Balance Check
    Route::get('/get-donor-balance', [DonorBalanceController::class, 'index'])
        ->name('donorBalance');
    Route::post('/get-donor-balance', [DonorBalanceController::class, 'balanceUpdate']);

    /*
    |----------------------------------------------------------------------
    | FRONTEND CONTENT - ABOUT
    |----------------------------------------------------------------------
    */
    // About Help
    ...
    Route::get('/about-help/delete/{id}', [AboutController::class, 'abouthelpdelete'])
        ->name('abouthelp.delete');

    // About Content
    Route::get('/about-content', [AboutController::class, 'aboutcontentshow'])
        ->name('aboutcontent.show');
    Route::get('/about-content/{id}', [AboutController::class, 'aboutcontentedit'])
        ->name('aboutcontent.edit');
    Route::post('/about-content/{id}', [AboutController::class, 'aboutcontentupdate'])
        ->name('aboutcontent.update');

    /*
    |----------------------------------------------------------------------
    | FRONTEND CONTENT - NEWS, FAQ
    |----------------------------------------------------------------------
    */
    ...
    |----------------------------------------------------------------------
    */
    Route::get('/admin-contact', [ContactController::class, 'admincontact'])
        ->name('admin.contact');
    Route::get('/admin-contact-mail', [ContactController::class, 'contactMail'])
        ->name('admin.contactmail');
    Route::get('/admin-contact-mail/edit/{id}', [ContactController::class, 'ContactmailEdit'])
        ->name('contactmail.edit');
    Route::post('/admin-contact-mail/{id}', [ContactController::class, 'mailUpdate'])
        ->name('contactmail.update');

    /*
    |----------------------------------------------------------------------
    | ONEGIV CARD MANAGEMENT
    |----------------------------------------------------------------------
    */
    ...
    /*
    |----------------------------------------------------------------------
    | AUDIT - BALANCE CHECKS
    |----------------------------------------------------------------------
    */
    Route::get('/audit-charities', [AdminController::class, 'auditBalances'])
        ->name('admin.audit.balances');
    Route::get('/audit-transaction/details', [AdminController::class, 'getDayDetails'])
        ->name('audit.dailytransaction.details');
